...
SEARCH_MODEL = os.getenv("SEARCH_MODEL", "qwen3.5:9b")
CODE_MODEL = os.getenv("CODE_MODEL", "qwen2.5-coder:7b")
REFACTOR_MODEL = os.getenv("REFACTOR_MODEL", "qwen2.5-coder:14b")
HELPER_MODEL = os.getenv("HELPER_MODEL", "qwen2.5:1.5b-instruct")
ROUTER_MODEL = os.getenv("ROUTER_MODEL", "qwen2.5:1.5b-instruct")
